...
import dev.bahodir.realtimefirebaseentrance.databinding.DialogItemBinding
import dev.bahodir.realtimefirebaseentrance.databinding.FragmentGroupsBinding
...
class GroupsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.fabAdd.setOnClickListener {
            var bind = DialogItemBinding.inflate(layoutInflater)
